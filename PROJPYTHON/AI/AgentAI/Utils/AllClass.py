...
class Enhance(BaseModel):
    ...
    sub_questions:list=Field(description="break the user query into questions")
...
class Step(BaseModel):
    ...
    agent:Literal["memory_agent","rag_agent","web_agent","Sql_Image_agent"]=Field(description="choose the appropriate agent")
